(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@fortawesome/fontawesome-svg-core'), require('riot'), require('sorted-json-stringify')) :
  typeof define === 'function' && define.amd ? define(['exports', '@fortawesome/fontawesome-svg-core', 'riot', 'sorted-json-stringify'], factory) :
  (global = global || self, factory(global.RiotFontAwesome = {}, global.FontAwesome, global.riot, global.sortedJSONStringify));
}(this, function (exports, fontawesomeSvgCore, riot, sortedJSONStringify) { 'use strict';
